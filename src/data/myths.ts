...
export const myths: Myth[] = [
  ...
  },
  {
    ...
    explanation: "Nein, das Bitcoin-Netzwerk selbst wurde noch nie gehackt. Probleme entstehen meist durch unsichere Wallets oder Börsen, nicht durch Bitcoin selbst. Das Netzwerk wird durch tausende Computer weltweit gesichert und ist damit eines der sichersten Computernetzwerke der Welt.",
    isMyth: false
  },
  {
    id: 3,
  ...
  },
  {
    ...
    explanation: "Ja, Bitcoin hat einen realen Wert durch sein Netzwerk, Sicherheit und Knappheit. Als erstes digitales, knappes Gut bietet es einzigartige Eigenschaften: unveränderliche Geldpolitik, globale Übertragbarkeit und dezentrale Sicherheit. Diese Eigenschaften machen es zu einem wertvollen digitalen Gut und Wertspeicher.",
    isMyth: true
  },
  {
    id: 7,
  ...
  },
  {
    ...
    explanation: "Nein, Bitcoin-Transaktionen sind nach mehreren Bestätigungen endgültig und können nicht rückgängig gemacht werden. Diese Unveränderlichkeit ist ein Kernmerkmal von Bitcoin und macht es zu einem verlässlichen System für Werttransfers. Für Händler bedeutet dies Schutz vor Rückbuchungen.",
    isMyth: false
  },
  {
    id: 14,
